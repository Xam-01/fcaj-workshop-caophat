...
2. Select **IAM users** in the left menu, then click **Create user**.
   ![IAM List]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_list.png)
3. Enter User Details:
   ...
   - Click **Next**.
   ![Create IAM User]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_create_user.png)
...
2. Under the **Permissions** tab, click **Add permissions** and select **Create inline policy**.
   ![Add Permission]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_add_permission.png)
   ![Permission Options]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_perm_options.png)
3. In the Policy Editor interface, select the **JSON** tab.
   ![Policy Editor]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_policy_editor.png)
4. Paste the following JSON policy configuration to allow the user to upload (`PutObject`) and delete (`DeleteObject`) files within the `smartmenu-assets-2026` bucket (replace with your actual bucket name):
   ...
   ```
   ![Policy JSON]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_policy_json.png)
5. Click **Next**.
6. Name the policy `SmartMenuS3UploadPolicy`, review the configuration settings, and click **Create policy**.
   ![Policy Name]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_policy_name.png)
...
2. Scroll down to the **Access keys** section and click **Create access key**.
   ![Create Access Key]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_access_key.png)
3. Select **Application running outside AWS** as the Use case (as our Backend runs on Lambda or local machine connecting directly to AWS). Click **Next**.
   ![Access Key Use Case]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_access_key_usecase.png)
4. Set a description tag, e.g., `SmartMenu API`. Click **Create access key**.
   ![Access Key Tag]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/iam_access_key_tag.png)
...
![Upload Verification]({{< baseurl >}}images/5-Workshop/5.3-IAM-Uploader/s3_uploaded_verification.png)
